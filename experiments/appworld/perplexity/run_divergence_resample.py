...
Example (sampled regime):
    python -m perplexity.run_divergence_resample \
        ...
        --source_cache_dir perplexity/outputs/divergence_cache_fullbaselines/qwen35a3b_self_cumulative_b2048_t6000 \
        --agent_base_url http://r818u33n08:8000/v1 \
        --temperature 0.6 --top_p 0.95 --top_k 20 --min_p 0.0 \
        --presence_penalty 0.0 --repetition_penalty 1.0 \
        --tag sampled --output perplexity/outputs/divergence_fullbaselines_sampled_b2048.json
"""
