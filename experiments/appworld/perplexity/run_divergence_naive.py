...
Example (greedy, the default):
    python -m perplexity.run_divergence_naive \
        ...
        --tag greedy --output perplexity/outputs/divergence_naive_greedy_b2048.json

Sampled:
    ... --temperature 0.6 --top_p 0.95 --top_k 20 --min_p 0.0 \
        --presence_penalty 0.0 --repetition_penalty 1.0 \
        --tag sampled --output perplexity/outputs/divergence_naive_sampled_b2048.json
"""
...
from perplexity.divergence import build_context, parse_plan, with_plan_instruction  # noqa: E402
